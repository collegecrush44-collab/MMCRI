      ...
      <div className="bg-white max-w-5xl w-full rounded-2xl shadow-xl flex overflow-hidden border border-slate-200 min-h-[600px]">
        ...
        <div className="w-2/5 bg-gradient-to-br from-blue-700 to-indigo-800 p-12 text-white hidden md:flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
              ...
              <div className="text-[9px] space-y-1 text-blue-100 opacity-80 font-mono bg-black/20 p-3 rounded-lg border border-white/10 overflow-y-auto max-h-32 custom-scrollbar">
                  ...
                  <div className="flex justify-between"><span>Pharmacist</span> <span>pharmacist / password</span></div>
                  <div className="flex justify-between"><span>Accountant</span> <span>accountant / password</span></div>
                  <div className="flex justify-between"><span>Lab Tech</span> <span>lab_tech / password</span></div>
                  <div className="flex justify-between"><span>Pathologist</span> <span>pathologist / password</span></div>
              </div>
          </div>
        </div>
